...
class JobRecommender:
    def __init__(
        ...
        embedding_onnx_path: str = None,  # Kept for backward compatibility, not used anymore
        tfidf_max_features: int = 5000,
        tfidf_batch_size: int = 50000
    ):
        # Initialize embedding model
        self.embedder = JinaEmbedV3(model_path=embedding_model_path)
...
if __name__ == "__main__":
    ...
    recommendations = recommender.recommend(
        resume_pdf_path="Resume.pdf", # change this to your resume path
